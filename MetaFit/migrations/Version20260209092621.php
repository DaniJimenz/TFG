 ...
 */
final class Version20260209092621 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, email VARCHAR(200) NOT NULL, password VARCHAR(200) NOT NULL, name VARCHAR(50) NOT NULL, lastname VARCHAR(255) NOT NULL, points_xp INT NOT NULL, continuity INT NOT NULL, level INT NOT NULL, rol VARCHAR(100) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, age INT NOT NULL, height DOUBLE PRECISION NOT NULL, gender VARCHAR(1) NOT NULL, actual_weight DOUBLE PRECISION NOT NULL, purpose VARCHAR(255) NOT NULL, activity_level VARCHAR(50) NOT NULL, PRIMARY KEY (id))');
